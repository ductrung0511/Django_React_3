...
export default function Resources(){
    ...
    if(data.is_staff) return <div>
      ...
      <div className="text-3xl font-bold text-red-400 my-10"> Resource currently not support Student</div>
      ...
      <div className="text-base font-light text-black my-10">Just kidding -:) Student can only see but not edit the resources</div>     
