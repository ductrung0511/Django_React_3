...
export default function ProfileCard({profileData}){
  ...
  console.log(exerciseLog, "ExerciseLog in ProfileCard");
                    ...
                    <div className="px-4 bg-gray-300 rounded-lg">
                        {data.map((exercise) => {
                          ...
                          <div className="border-b  py-4 border-gray-400 border-dashed ">
                              ...
                              {exercise.type === "multiple_choice" && <Exercise questionsData={exercise.questions} instruction={exercise.instruction} setExerciseLog={setExerciseLog} exerciseID={exercise.id} exerciseLog={exerciseLog}  /> }
