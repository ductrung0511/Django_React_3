    ...
    return(
            ...
            <div className="p-1 grid grid-cols-1 bg-color-vibrant/10 pl-1 ">
                        ...
                        */}
                        ...
                        <CreateCourse addOrUpdateCourse={updateCourse} id={course.id} course={updatedCourseData}/>
                        ...
                        <div className= {`pt-4 py-2 px-10 w-3/4  rounded-xl shadow-lg  bg-${course.color}-100 grid grid-cols-2 text-white `}>
                            <div className=" pl-2 col-span-2 text-left rounded-lg text-black"> 
                                ...
                                <p className="text-sm mt-0 "> Showing and hiding your dialog
                                Dialogs have no automatic management of their open/closed state. To show and hide your dialog, pass React state into the open prop. When open is true the dialog will render, and when it's false the dialog will unmount.</p>
                        ...
                        <p className="text-sm my-4 font-extralight text-gray-200 text-left border-1 "> </p> 
                        <div className="ml-7 px-5 h-80 overflow-y-auto border-transparent border-1 border-black py-5 rounded-lg">
                        ...
                        <div className="m-2 px-2  rounded-xl bg-white/30 grid ">
                            ...
                            {sessions.map((session, index) => {
                                ...
                                <CreateSession addOrUpdateSession={addSession} courseID={props.id}/>
