...
function Exercise( {setExerciseLog, questionsData, instruction, exerciseLog, exerciseID}) {

    console.log({setExerciseLog, questionsData, instruction, exerciseLog, exerciseID}, "EX");
    ...
    console.log(exerciseLog,"OPTIONS");
