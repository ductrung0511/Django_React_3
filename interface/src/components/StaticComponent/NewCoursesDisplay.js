...
export default function NewCoursesDisplay({courseCategories}){
    ...
    const [courseSaveList, setCourseSaveList] =  useState(localStorage.getItem('courseSave').split('/'))
    ...
    return(
        ...
        <div className='grid grid-cols-3 gap-4 justify-center items-center pt-10 px-10'>
            ...
            <div className={`rounded-xl p-7 w-49 bg-white text-yellow-400 text-center cursor-pointer shadow-lg hover:bg-black ease-in duration-700`}>
        ...
        <div className="grid grid-cols-8 gap-3 px-10 mt-10 ">
            <div className=" mb-5 col-span-5 grid grid-cols-5 border border-transparent rounded-lg duration-700 bg-orange-200 hover:shadow-lg hover:bg-orange-300 w-full h-48">
                <div className="flex flex-col col-span-2 justify-center">
                    <img src="https://aec88.vn/wp-content/uploads/2024/01/Kindy-2.png" className="w-24  h-auto ml-24 rounded-lg"/>
                ...
                <div className=" col-span-3 bg-white shadow-md hover:bg-yellow-200 rounded-lg w-4/5 h-full my-4 px-4 py-2">
            ...
            <div className=" pr-2 mb-30 col-span-3  grid grid-cols-6 border border-transparent rounded-lg duration-700 bg-yellow-200 hover:shadow-lg hover:bg-green-300 w-full h-48">
                <div className="flex flex-col col-span-3  items-start mt-3">
                    <img src="https://aec88.vn/wp-content/uploads/2024/01/Kids.png" className="w-24 h-auto ml-10 rounded-lg"/>
                ...
                <div className=" col-span-3 bg-white hover:bg-yellow-200 rounded-lg  shadow-lg  h-full  my-1 mt-4 w-72 px-4 py-1 ">
            ...
            <div className=" col-span-4 grid grid-cols-5 border border-transparent rounded-lg duration-700 bg-blue-200 hover:shadow-lg hover:bg-blue-300 w-full h-48">
                <div className="flex flex-col col-span-2 justify-center mb-7">
                    <img src="https://aec88.vn/wp-content/uploads/2023/01/become-01.png" className="w-24  h-auto ml-16 rounded-lg"/>
                ...
                <div className=" col-span-3 bg-white shadow-lg hover:bg-yellow-200 rounded-lg w-4/5 h-full  my-4 px-4 py-1">
            ...
            <div className=" col-span-4 grid grid-cols-5 border border-transparent rounded-lg duration-700 bg-green-200 hover:shadow-lg hover:bg-green-300 w-full h-48">
                <div className="flex flex-col col-span-2 justify-center mb-14">
                    <img src="https://aec88.vn/wp-content/uploads/2024/01/Teaching-with-us-2048x1365.png" className="w-24  h-auto ml-16 rounded-lg"/>
            ...
            <div id="STARTER" className="grid grid-cols-6 px-7 gap-1 mt-32 relative">
                <div className="col-span-1 row-span-3  my-2 ml-2 w-full rounded-lg bg-gray-800">
                    <img className="object-cover w-full h-screen" src="https://img.freepik.com/free-vector/gradient-real-estate-poster-with-photo_23-2148938296.jpg?w=740&t=st=1709368706~exp=1709369306~hmac=6bfa50609cdda137fe2e0e64c95ba1b5bd7cd64050592115d2de679d23220f45"/>
                </div>
                        ...
                        return (
                            <div className="col-span-2 relative" key={course.name}> 
                                ...
                                <NavLink to={'/workspace/courses/' + course.id} className='no-underline '>
                                        ...
                                        <div className={`flex flex-col p-3 gap-3 w-72 bg-${course.color}-200 rounded-lg absolute bottom-3 right-3 hover:bg-green-400 `} >
